...
import fullReplay from '../fixtures/sample-replay.json';
import partialReplay from '../fixtures/partial-replay.json';

// Window.dataLayer is declared globally in vite-env.d.ts
