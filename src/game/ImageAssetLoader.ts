...
export class ImageAssetLoader {
  ...
  static initializeAssets(): void {
    ...
    // Monster assets - key monsters for the game (all 11 monster files)
    this.monsterAssets = [
      ...
      { key: 'monster-quaternion-poster-5', path: '/assets/monsters/DALL·E 2024-11-22 18.44.15 - Design an enhanced sci-fi movie poster for \'Quaternion,\' focusing on the battle between a colossal monster and three futuristic starships. The monster.webp', category: 'monster' },
      ...
      { key: 'monster-elemental-2', path: '/assets/monsters/DALL·E 2024-11-22 18.54.19 - Design a breathtaking sci-fi illustration for \'Quaternion_ Defend the Dimensions.\' Depict a massive elemental monster formed from four floating island.webp', category: 'monster' },
      { key: 'monster-elemental-3', path: '/assets/monsters/DALL·E 2024-11-22 19.02.15 - Create a visually striking and highly original sci-fi illustration for \'Quaternion_ Defend the Dimensions.\' Center the image on a colossal monster for.webp', category: 'monster' },
